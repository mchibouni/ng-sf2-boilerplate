...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // api_dummy_get_dummy
        if (0 === strpos($pathinfo, '/api/dummy') && preg_match('#^/api/dummy(?:\\.(?P<_format>json|xml|html))?$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_api_dummy_get_dummy;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_dummy_get_dummy')), array (  '_controller' => 'AppBundle\\Controller\\Rest\\DummyController::getDummyAction',  '_format' => NULL,));
        }
        not_api_dummy_get_dummy:
